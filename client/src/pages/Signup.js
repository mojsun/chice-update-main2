...
function Signup(props) {
  ...
  return (
    <div className="container signup my-1">
      ...
      {/* Mobile/Tablet layout: background video with overlay form */}
      <div className="d-lg-none signup-overlay-container">
        <video className="signup-overlay-video" autoPlay muted loop>
          <source src="/videos/signup.mp4" type="video/mp4"></source>
        </video>
        <div className="signup-overlay-form p-4">
          <Link to="/login" className="text-decoration-none text-white">
            ← Go to Login
          </Link>

          <h2 className="mt-3 mb-3 text-white">Signup</h2>
          <form onSubmit={handleFormSubmit}>
            <div className="flex-row space-between my-2">
