...
function ProductDetailsRightWomen({ selectedSize, selectedColor, maxPrice }) {
      ...
      >
        ...
        <div className="card-body ">
          ...
          <button
            ...
            className=" card-body-button btn btn-warning border rounded-3 p-2 w-100 text-white shadow d-flex justify-content-center align-items-center gap-2"
          >
            <i className="fas fa-shopping-cart" aria-hidden="true"></i>
            <span className="text-decoration-none">Add to cart</span>
          </button>
        </div>
      </div>
    ));
